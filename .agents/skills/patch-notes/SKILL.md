...
1. Check `.agents/docs/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. Glob for `docs/patch-notes-template.md` and `.agents/docs/templates/patch-notes-template.md`.
