#!/bin/bash
# Provider-neutral harness SessionStart hook: Load project context at session start
# Outputs context information that the harness sees when a session begins
#
# Input schema (SessionStart): No stdin input

echo "=== GameStudio — Session Context ==="
