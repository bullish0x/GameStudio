...
| **D4 — highest reasoning tier** | Agent is assigned highest-reasoning tier per coordination-rules.md |
...
| **L3 — balanced reasoning tier** | Agent is assigned balanced-reasoning tier (default) per coordination-rules.md |
