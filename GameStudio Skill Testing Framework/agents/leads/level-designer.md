...
**Reasoning tier:** balanced reasoning (individual system analysis — level design review and encounter assessment).
...
- [ ] Reasoning tier is balanced-reasoning tier per coordination-rules.md
