...
| File | Purpose |
|------|---------|
| `catalog.yaml` | Master registry for all 183 skills and 55 agents. Contains category, spec path, and last-test tracking fields. Always read this first when running any test command. |
