#!/bin/bash
# Codex-compatible harness SubagentStart hook: Log agent invocations for audit trail
# Tracks which agents are being used and when
#
# Input schema (SubagentStart) — per Codex-compatible harness hooks reference:
